...
public class MyTabView extends View {
    ...
    private void initData() {
        view_bg_corners = dp2px(mContext, 5);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (tabPosition == 0) {
            ...
            pathLeft.cubicTo(textWidth + arcControlX, arcControlY,
                    textWidth + arcWidth - arcControlX, viewHeight - arcControlY,
                    textWidth + arcWidth, viewHeight);
