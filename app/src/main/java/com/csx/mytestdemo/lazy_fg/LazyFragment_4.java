...
public class LazyFragment_4 extends BaseFragment {
    private static final String TAG = LazyFragment_4.class.getSimpleName().toString();
    @BindView(R.id.lazy_tv)
    TextView mLazyTv;

    public LazyFragment_4(){
        super();
        Log.d(TAG, "LazyFragment_4: ");
    }
