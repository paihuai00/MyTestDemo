...
public class LazyFragment_3 extends BaseFragment {
    private static final String TAG = LazyFragment_3.class.getSimpleName().toString();
    @BindView(R.id.lazy_tv)
    TextView mLazyTv;
    public LazyFragment_3(){
        super();
        Log.d(TAG, "LazyFragment_3: ");
    }
    @Override
